  ...
  return (
    <GoogleOAuthProvider clientId={clientId} locale="en">
      <div className="flex flex-col gap-4">
        {error && (
          <div className="flex h-10 w-full items-center border border-red-200 bg-red-50 px-4 text-xs text-red-600">
            {error}
          </div>
        )}
